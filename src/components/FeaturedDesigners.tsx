...
const designers: DesignerProfileDetail[] = [
  {
    ...
    outputItems: [
      {
        ...
        result:
          "Improved on-site wayfinding and reduced confusion at key booths.",
    ...
    processImage: "/images/michael%201.svg",
  },
  {
    ...
    processImage: "/images/jean%201.svg",
  },
  {
    ...
    processImage: "/images/erries%201.svg",
  },
];
